...
Для оригинального voxlap клиента есть modloader - патч с разными улучшениями, основные - это менеджер модификаций файлов игры, запись логов чата и возможность задать цвет фона для чата (чтобы было лучше видно буквы).  
