...
Открываются и редактируются в slab6 (он также встроен в spadille, лучше там использовать). http://www.advsys.net/ken/download.htm  
...
Убрана функция lower(), из-за которой имя карты неправильно отображалось и соответственно вводилось - карта, в имени которой буквы разных регистров, не выбиралась.  
